    ...
    >
      <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-8 md:p-10">
        ...
        <div className="space-y-4 text-base leading-7 text-slate-300">
          <p>
            IN TIME — современное бюро переводов в Душанбе,
            специализирующееся на профессиональном переводе документов,
            текстов и официальных материалов.
          </p>

          <p>
            Мы выполняем письменные и устные переводы, переводим паспорта,
            свидетельства, дипломы, медицинские и юридические документы,
            а также оказываем услуги нотариального заверения, апостиля
            и легализации документов.
          </p>

          <p>
            Перевод выполняется с учётом языковых, юридических и
            профессиональных требований. Мы работаем с русским,
            таджикским, английским и другими распространёнными языками.
          </p>

          <p>
            Наш офис находится в центре Душанбе: проспект Рудаки, 83,
            ЦУМ, 3 этаж, офис 16К. Клиенты могут обратиться в IN TIME
            для получения консультации и оформления перевода документов.
          </p>
        </div>
